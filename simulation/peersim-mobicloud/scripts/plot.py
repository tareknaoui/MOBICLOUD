...
ax1.set_xlabel('Cycles de gossip (1 cycle = 2 secondes simulees)')
ax1.set_ylabel('Taille moyenne de la DHT par noeud (sur 100 blocs)')
ax1.set_title('Convergence du gossip CRDT LWW (MobiCloud) -- ZOOM')
...
ax2.set_xlabel('Cycles de gossip (1 cycle = 2 secondes simulees)')
ax2.set_ylabel('% de noeuds avec DHT complete')
ax2.set_title('Pourcentage de noeuds converges -- ZOOM')
...
ax3.set_xscale('log')
ax3.set_xlabel('Cycles de gossip (echelle log)')
ax3.set_ylabel('% de noeuds avec DHT complete')
ax3.set_title('Convergence en echelle logarithmique -- meilleure vue des differences')
